...
psid_household_wealth_chosen_period_df.to_csv('data.csv')
...
counts, bin_edges, patches = plt.hist(symlog1p(psid_household_wealth_chosen_period_df['IMP WEALTH W/ EQUITY']), bins=200, histtype='stepfilled', alpha=0.8)
...
#================================================================
# Household net worth by percentile (scatter)
#================================================================
# Set up figure
plt.figure(figsize=(14, 8))
...
#================================================================
# log Household net worth by percentile (scatter)
#================================================================
# Set up figure
plt.figure(figsize=(14, 8))
...
#================================================================
# log-log Household net worth by percentile (scatter)
#================================================================
# Set up figure
plt.figure(figsize=(14, 8))
...
#================================================================
# symlog Household net worth by percentile (scatter)
#================================================================
# Set up figure
plt.figure(figsize=(14, 8))
